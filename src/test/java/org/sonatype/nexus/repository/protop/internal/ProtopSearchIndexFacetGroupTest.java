...
public class ProtopSearchIndexFacetGroupTest
    extends TestSupport
{
  @Mock
  ...
  private ProtopSearchIndexFacetGroup underTest;
  ...
  public void setUp() throws Exception {
    ...
    }).getInstance(ProtopSearchIndexFacetGroup.class);
  ...
  public void whenRepositoryIsNotAMemberOfGroup_shouldNotInvalidateCache() {
    ...
    underTest.on(new ProtopSearchIndexInvalidatedEvent(eventRepository));
  ...
  private void isInvalidateCacheCalled(final int i) {
    ...
    verify(eventManager, times(i)).post(any(ProtopSearchIndexInvalidatedEvent.class));
  }
}
