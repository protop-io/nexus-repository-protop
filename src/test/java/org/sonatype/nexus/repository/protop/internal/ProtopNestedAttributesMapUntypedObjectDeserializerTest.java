...
public class ProtopNestedAttributesMapUntypedObjectDeserializerTest
    extends TestSupport
{
  ...
  private ProtopNestedAttributesMapUntypedObjectDeserializer underTest;
  ...
  public void setUp() {
    ...
    underTest = spy(new ProtopNestedAttributesMapUntypedObjectDeserializer(parser));
  }

  @Test
  @SuppressWarnings("unchecked")
  public void default_Protop_Overlaying() throws IOException {
