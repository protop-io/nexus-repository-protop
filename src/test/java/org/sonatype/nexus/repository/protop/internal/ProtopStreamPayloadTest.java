...
public class ProtopStreamPayloadTest
    extends TestSupport
{
  @Spy
  ...
  private ProtopStreamPayload underTest;

  @Before
  public void setUp() {
    underTest = spy(new ProtopStreamPayload(inputStreamSupplier));
  }

  @Test
  public void copy_Uses_ProtopStreaming() throws IOException {
