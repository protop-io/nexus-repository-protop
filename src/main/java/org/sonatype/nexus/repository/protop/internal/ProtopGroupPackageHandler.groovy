...
import static org.sonatype.nexus.repository.protop.internal.ProtopResponses.notFound
import static org.sonatype.nexus.repository.protop.internal.ProtopResponses.ok
...
@Named
@Singleton
class ProtopGroupPackageHandler extends ProtopGroupHandler {
